...
function App() {
    ...
    const [tigerScore, setTigerScore] = useState("0") // Give these better names (they were originally set at value and setValue), and decide whether you want to pass an initial score into the state hook as the initialValue
